...
// Patient represents a nutritionist's patient record with nested JSON fields
type Patient struct {
	PatientID                    string         `json:"patientId" gorm:"primaryKey"`
	PersonalData                 datatypes.JSON `json:"personalData" gorm:"type:jsonb"`
	HealthHistory                datatypes.JSON `json:"healthHistory" gorm:"type:jsonb"`
	Habits                       datatypes.JSON `json:"habits" gorm:"type:jsonb"`
	ClinicalEvaluations          datatypes.JSON `json:"clinicalEvaluations" gorm:"type:jsonb"`
	AnthropometricAssessments    datatypes.JSON `json:"anthropometricAssessments" gorm:"type:jsonb"`
	NutritionalNeedsCalculations datatypes.JSON `json:"nutritionalNeedsCalculations" gorm:"type:jsonb"`
	DietPlans                    datatypes.JSON `json:"dietPlans" gorm:"type:jsonb"`
	NutritionalGuidance          datatypes.JSON `json:"nutritionalGuidance" gorm:"type:jsonb"`
	GeneratedDocuments           datatypes.JSON `json:"generatedDocuments" gorm:"type:jsonb"`
}
